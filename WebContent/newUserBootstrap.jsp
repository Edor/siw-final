		...
		<div class="container">
			...
			<div class="col-md-6 col-md-offset-3">
				...
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-12">
							<h:form id="Registration-form" style="display: block;">
								...
								<div class="form-group">
									...
									<h:message for="firstName" styleClass="label label-warning" />
								...
								<div class="form-group">
									...
									<h:message for="lastName" styleClass="label label-warning" />
								...
								<div class="form-group">
									<h:outputLabel for="middleName" value="Middle Name"
										styleClass="mail1" />
									<h:inputText value="#{userController.middleName}"
										id="middleName" styleClass="form-control" tabindex="1"
										label="middleName" />
								...
								<div class="form-group">
									<h:outputLabel for="shippingAddress" value="Address"
										styleClass="mail1" />
									<h:inputText value="#{userController.shippingAddress}"
										id="shippingAddress" required="true" styleClass="form-control"
										tabindex="1" label="shippingAddress" />

									<h:message for="shippingAddress"
